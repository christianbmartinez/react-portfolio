  ...
  return (
    <section>
      ...
      <motion.div
        ...
        className='container mt-52 md:mt-52 px-6 mx-auto lg:w-2/3'
      >
        <div className='container min-h-[70vh] text-slate-800 px-4 md:px-12 relative top:0 md:top-20'>
          <div className='block rounded-xl mt-[-100px] bg-white shadow-xl py-10 md:py-12 px-4 md:px-6'>
            <div className='grid grid-cols-3 mb-12 max-w-[700px] mx-auto'>
              <div className='mb-12 lg:mb-0 text-center mx-auto'>
                <svg
                  className='w-6 h-6 md:w-8 md:h-8 text-teal-500 mb-6 mx-auto hover:text-teal-600'
                ...
                <h6 className='font-medium text-sm md:text-md text-zinc-800'>
            ...
            ease-in-out
            m-0
            focus:text-zinc-700 focus:bg-white focus:border-teal-500 focus:outline-none'
                    id='name'
                    name='name'
                    placeholder='Name'
                    value={formData.name || ''}
          ...
          focus:bbg-teal-500  focus:shadow-lg focus:outline-none focus:ring-0
          active:bg-teal-500 active:shadow-lg
          transition
          duration-150
          ease-in-out'
                >
